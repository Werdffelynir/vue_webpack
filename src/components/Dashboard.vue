...
<script>
    ...
    const cards = [
        ...
        },
        {
            id: 4,
            title: 'Card Fore',
            text: 'Assumenda beatae delectus eligendi eveniet excepturi, hic illum magnam obcaecati. Blanditiis cumque earum, id ipsam saepe totam. , iure non saepe veniam.'
        },
    ];
